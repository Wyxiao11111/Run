...
import com.example.wyx.run.orient.OrientSensor;
import com.example.wyx.run.step.StepSensorAcceleration;
import com.example.wyx.run.step.StepSensorBase;
import com.example.wyx.run.step.StepSensorPedometer;
import com.example.wyx.run.util.SensorUtil;
